...
if __name__ == '__main__':
    try:
        ...
        group_5.append([257.8275, 116.439807692, -283.419, 176.63056338, 76.1184507042]) # forward
        group_5.append([257.8275, 116.439807692, -283.419, 202.024788732, 76.1184507042]) # backward
        group_5.append([257.8275, 116.439807692, -283.419, 189.016478873, 46.4805633803]) # left
        group_5.append([257.8275, 116.439807692, -283.419, 189.016478873, 106.376197183]) # right
        
        group_9 = []
        group_9.append([257.8275, 116.439807692, -283.419, 189.016478873, 76.1184507042]) # middle
        group_9.append([257.8275, 116.439807692, -283.419, 179.016478873, 76.1184507042]) # forward 1
        group_9.append([257.8275, 116.439807692, -283.419, 174.63056338, 76.1184507042]) # forward 2
        group_9.append([257.8275, 116.439807692, -283.419, 199.016478873, 76.1184507042]) # backward 1
        group_9.append([257.8275, 116.439807692, -283.419, 204.016478873, 76.1184507042]) # backward 2
        group_9.append([257.8275, 116.439807692, -283.419, 189.016478873, 56.1184507042]) # left 1
        group_9.append([257.8275, 116.439807692, -283.419, 189.016478873, 36.1184507042]) # left 2
        group_9.append([257.8275, 116.439807692, -283.419, 189.016478873, 96.1184507042]) # right 1
        group_9.append([257.8275, 116.439807692, -283.419, 189.016478873, 116.1184507042]) # right 2
