...
def print_urdf(xyz, rpy):
    print("""
    <joint name=\"azure_rgb_joint\" type=\"fixed\">
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='calculate transform from azure_rgb_optical_frame to azure_ir_optical_frame')
